...
import com.zd.testing.business.model.Unit;
import com.zd.testing.business.model.UnitExample;
...
public interface UnitMapper {
	 ...
	 * @mbggenerated  Fri Jun 08 15:35:41 CST 2018
	 */
	int updateByExampleSelective(@Param("record") Unit record,
			@Param("example") UnitExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table unit
	 * @mbggenerated  Fri Jun 08 15:35:41 CST 2018
	 */
	int updateByExample(@Param("record") Unit record,
			@Param("example") UnitExample example);
